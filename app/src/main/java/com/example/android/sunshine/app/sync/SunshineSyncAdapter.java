...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onConnected(Bundle bundle) {
        Log.d(LOG_TAG, "mGoogleApiClient - onConnected");
    ...
    // Referenced the Google Data API sample code for this method
    private void updateWearData(double aHigh, double aLow, int aWeatherId) {

        int weather = Utility.getArtResourceForWeatherCondition(aWeatherId);
        Bitmap bitmap = BitmapFactory.decodeResource(getContext().getResources(),weather);
        Asset asset = createAssetFromBitmap(bitmap);

        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create("/weather");
        putDataMapRequest.getDataMap().putLong("timestamp", System.currentTimeMillis());
        putDataMapRequest.getDataMap().putInt("high", (int) aHigh);
        putDataMapRequest.getDataMap().putInt("low", (int) aLow);
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, request).setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
            ...
            public void onResult(DataApi.DataItemResult dataItemResult) {
                if (dataItemResult.getStatus().isSuccess()){
                    Log.d(LOG_TAG, "Succesfully sent data to wearable");
                } else {
                    Log.e(LOG_TAG, "Error - Could not send data to wearable");
                }
            }
        });
    }
